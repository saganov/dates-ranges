(function() {
    let init = function() {
        const request = {
            ...
            'action': function () {
                ...
                document.querySelectorAll('input[type=button][value=Update]').forEach(function(button) {
                    button.onclick = function(e){
                        add(e.target);
                    }
                });
                document.querySelectorAll('input[type=button][value=Delete]').forEach(function(button) {
                    button.onclick = function(e){
                        del(e.target);
                    }
                });
    ...
    let add = function(target) {
        ...
        const request = {
            ...
            'error': function () {
                console.error('Ranges updating fail');
            }
        };
        apiCall(request);
    };
